...
class ParentDashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        feesCard = findViewById(R.id.feesCard)
    ...
    private fun loadUserData() {
        ...
        lifecycleScope.launch {
            ...
            result.onSuccess { user ->
                ...
                Toast.makeText(this@ParentDashboardActivity, "Error loading user data", Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun setupClickListeners() {
        attendanceCard.setOnClickListener {
            Toast.makeText(this, "Attendance feature - View your child's attendance records", Toast.LENGTH_SHORT).show()
        }

        homeworkCard.setOnClickListener {
            Toast.makeText(this, "Homework feature - View assigned homework", Toast.LENGTH_SHORT).show()
        }

        noticesCard.setOnClickListener {
            Toast.makeText(this, "Notices feature - View school notices", Toast.LENGTH_SHORT).show()
        }

        examsCard.setOnClickListener {
            Toast.makeText(this, "Exams feature - View exam schedules", Toast.LENGTH_SHORT).show()
        }

        feesCard.setOnClickListener {
            Toast.makeText(this, "Fees feature - View and pay fees", Toast.LENGTH_SHORT).show()
        }

        messagesCard.setOnClickListener {
            Toast.makeText(this, "Messages feature - Chat with teachers", Toast.LENGTH_SHORT).show()
        }
